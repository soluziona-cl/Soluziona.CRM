...
import ReporteCargaTablaResumen from './Componentes/ReporteCargaTablaResumen'
                  ...
                  <div className="col-sm-12 col-lg-12">
                    <div className="card mb-4 rounded-3 shadow-sm">
                      ...
                      <div className="card-body">
                        <div key='123456'>
                          {mostrarGrid !== false && <ReporteCargaTablaResumen company={campana} />}
                        </div>
                        <div key='789578'>
                          {mostrarGrid2 !== false && <ReporteCargaTablaResumen company={campana} />}
                        </div>
