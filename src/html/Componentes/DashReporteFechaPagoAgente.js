...
function DashReporteFechaPagoAgente({company,agente}) {
    ...
    const Datos = (async () => {
        ...
        const result = await axios.post('https://app.soluziona.cl/API_v1_prod/Procollect/CRM/api/Ventas_CRM/CRM/Panel/Gestion/FechaPago/Agente',
         { dato: company, dato_3:agente  }, 
...
export default DashReporteFechaPagoAgente