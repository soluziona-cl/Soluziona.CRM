    ...
    <>
      ...
      {sesiones.sid_usuario === "1" ?
        <div id="sidebar-nav" className="list-group border-0 rounded-0 text-sm-start min-vh-100">
          ...
          <Link to={rutaservidor + '/Documentacion'} className='list-group-item    d-inline-block text-truncate'><div className='ml-2  text-slate-200 text-sm font-medium'><i className="fa-solid fa-code"></i><span className="ms-1  d-none d-sm-inline">Documentacion</span></div></Link>
