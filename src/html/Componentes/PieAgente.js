...
function PieAgente({company,agente}) {
    ...
    const Datos = (async () => {
        ...
        axios.post("https://app.soluziona.cl/API_v1_prod/Procollect/CRM/api/Ventas_CRM/CRM/Agente/Live/Agente", 
        { dato: '', dato_1: '', dato_2: agente },
