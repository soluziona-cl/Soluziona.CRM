...
function PieGestionAgente({company,agente}) {
    ...
    const Datos = (async () => {
        await axios.post('https://app.soluziona.cl/API_v1_prod/Procollect/CRM/api/Ventas_CRM/CRM/Panel/Gestion/Cargas/Agente',
...
export default PieGestionAgente