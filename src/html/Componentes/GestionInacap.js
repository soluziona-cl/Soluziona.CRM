...
function GestionInacap({ flujo, campana, ini, fin }) {
    ...
    const Datos = (async () => {
        ...
        const result = await axios.post('https://app.soluziona.cl/API_v1_prod/CallSouth/API_CallSouth_CRM_LosHeroes/api/Ventas_CRM/CRM/Resultado/Cargas/Gestion/Inacap',
