...
function BarrasAgente({company,agente}) {
    ...
    const Datos = (async () => {
        ...
        axios.post("https://app.soluziona.cl/API_v1_prod/Procollect/CRM/api/Ventas_CRM/CRM/Panel/Inbound/Intervalo/Now/Agente",
         { dato_1:agente  }, 
