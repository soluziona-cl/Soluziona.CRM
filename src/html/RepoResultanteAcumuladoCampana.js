...
import ReporteResultanteCampanaAcumuladoTabla from "./Componentes/ReporteResultanteCampanaAcumuladoTabla";
...
//con DataTable
const RepoResultanteAcumuladoCampana = () => {
        ...
        <div className="row flex-nowrap">
          ...
          <main className="col ps-md-2 pt-2">
            ...
            <div className="m-xs-0 m-lg-4"> <div className="page-header pt-3">
              <h2 className="page-header col-sm-12 col-lg-4 mt-lg-0 mt-sm-2 text-black">Reporte de Resultante Campaña Acumulado</h2>
            </div>
              <hr />
              <div className="row ">
              ...
              <section className="col-lg-12 col-md-12 col-sm-12 mt-2 ">
                {/* <TablaFull /> */}
                <div className="mt-2">
                  {mostrarGrid !== false && <ReporteResultanteCampanaAcumuladoTabla flujo={campana} ini={format(startdateini, "yyyyMMdd")} fin={format(startdatefin, "yyyyMMdd")} />}
                  {mostrarGrid2 !== false && <ReporteResultanteCampanaAcumuladoTabla flujo={campana} ini={format(startdateini, "yyyyMMdd")} fin={format(startdatefin, "yyyyMMdd")} />}
...
export default RepoResultanteAcumuladoCampana;
