          ...
          <main className="col ps-md-2 pt-2">
            ...
            <div className="m-xs-0 m-lg-4"> <div className="page-header pt-3">
              ...
              <section className="col-lg-12 col-md-12 col-sm-12 mt-2">
                {/* <TablaFull /> */}
                <div className="mt-2">
                  {mostrarGrid !== false && <ReporteTipificadasAgenteTabla flujo={campana} ini={format(startdateini, "yyyyMMdd")} fin={format(startdatefin, "yyyyMMdd")} nombre={flujo} />}
                  {mostrarGrid2 !== false && <ReporteTipificadasAgenteTabla flujo={campana} ini={format(startdateini, "yyyyMMdd")} fin={format(startdatefin, "yyyyMMdd")} nombre={flujo} />}
...
export default RepoTipificadasAgente;
