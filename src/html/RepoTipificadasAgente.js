        ...
        <div className="row flex-nowrap">
          ...
          <main className="col ps-md-2 pt-2">
            ...
            <div className="m-xs-0 m-lg-4"> <div className="page-header pt-3">
              <h2 className="page-header col-sm-12 col-lg-3 mt-lg-0 mt-sm-2 text-black">Reporte Tipificadas Agente</h2>
            </div>
              <hr />
              <div className="row">
                <div className="col-12">
                  ...
                  <section className="col-lg-12 col-sm-8 mt-2">
                    {/* <TablaFull /> */}
                    <div className=" mt-5 "  >
                    {mostrarGrid !== false && <ReporteTipificadasAgenteTabla flujo={company} campana={campana} ini={format(startdateini, "yyyyMMdd")} fin={format(startdatefin, "yyyyMMdd")} />}
                    </div>
